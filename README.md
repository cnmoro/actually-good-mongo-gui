...
![Connection dialog placeholder](docs/screenshots/02-connection-dialog.png)

### 3. Collection Data Grid

![Collection grid placeholder](docs/screenshots/03-collection-grid.png)

### 4. Document Drawer (Create/Edit JSON)

![Document drawer placeholder](docs/screenshots/04-document-drawer.png)

### 5. Aggregation Pipeline Builder

![Aggregation builder placeholder](docs/screenshots/05-aggregation-builder.png)

### 6. Indexes Management

![Indexes placeholder](docs/screenshots/06-indexes-tab.png)

### 7. Import / Export Actions

![Import export placeholder](docs/screenshots/7-import-export.png)

### 8. AI Query Generation

![AI generation config placeholder](docs/screenshots/8-ai-query-generation.png)

![AI generation placeholder](docs/screenshots/9-ai-query-generation.png)
